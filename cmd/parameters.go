...
func init() {
	...
	root.Flags().StringP("token", "", "", "CI mode requires a personal access token. Sign up at https://tapp.carbonetes.com/ and generate your token to enable integration.")
	root.Flags().StringP("plugin", "", "", "CI mode set plugin type. (default oss)")
